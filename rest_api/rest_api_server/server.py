    ...
    if not version or version == 'v2':
        ...
        profiling_urls = [
            ...
            (urls_v2.task_optimizations,
             ...
             handler_kwargs),
            (urls_v2.leaderboard_templates,
             h_v2.profiling.leaderboard_templates.LeaderboardTemplatesAsyncItemHandler,
             handler_kwargs),
            (urls_v2.leaderboard,
            ...
            (urls_v2.datasets_collection,
             ...
             handler_kwargs),
            (urls_v2.leaderboard_collection,
             h_v2.profiling.leaderboards.LeaderboardsAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.leaderboard_generate,
             h_v2.profiling.leaderboards.LeaderboardsAsyncGenerateHandler,
             handler_kwargs),
            (urls_v2.datasets,
