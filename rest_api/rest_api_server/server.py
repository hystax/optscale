    ...
    if not version or version == 'v2':
        ...
        result.extend([
            ...
            (urls_v2.power_schedules_actions,
             ...
             handler_kwargs),
            (urls_v2.power_schedule_run,
             h_v2.power_schedules.PowerScheduleRunAsyncHandler,
             handler_kwargs),
            (urls_v2.power_schedule_tag_actions,
             h_v2.power_schedules.PowerScheduleTagActionsAsyncHandler,
             handler_kwargs),
            (urls_v2.power_schedules_resources_live_state,
             h_v2.power_schedules.PowerScheduleResourcesLiveStateHandler,
             handler_kwargs),
