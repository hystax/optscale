...
from cloud_adapter.model import (InstanceResource, VolumeResource,
...
class TestCloudResourceApi(TestApiBase):
    ...
    @patch('rest_api_server.controllers.rule_apply.CloudIsCondition.match')
    ...
    def test_activities_task(self):
        m_task = patch('rest_api_server.controllers.base.'
