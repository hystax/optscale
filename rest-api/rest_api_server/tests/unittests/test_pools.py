...
from rest_api_server.models.models import Checklist, OrganizationLimitHit
...
class TestPoolApi(TestApiBase):
    ...
    def test_get_with_details_and_removed_children(self):
        get_expenses = patch(
            'rest_api_server.controllers.pool.PoolController.'
    ...
    def test_delete_pool_reassign_cleanup(self):
        ...
        user_assignments = [{
            ...
            'role_scope': None}]
        patch(
            'rest_api_server.controllers.invite.InviteController.get_invite_expiration_days',
            return_value=30).start()
        patch(
            'rest_api_server.controllers.invite.InviteController.check_user_exists',
            return_value=(True, {})).start()
        patch(
            'rest_api_server.controllers.invite.InviteController.get_user_auth_assignments',
            return_value=user_assignments).start()
        patch(
            'rest_api_server.handlers.v1.base.BaseAuthHandler._get_user_info',
            return_value={
    ...
    def test_patch_auto_extension_no_permission_in_root(self):
        ...
        patch('rest_api_server.controllers.pool.'
    ...
    @patch('rest_api_server.controllers.pool.PoolController.get_user_id')
    @patch('rest_api_server.controllers.pool.PoolController.'
