...
from optscale_exceptions.common_exc import HeraldException
...
class TestInviteApi(TestApiBase):
    ...
    def setUp(self, version='v2'):
        ...
        patch('rest_api_server.controllers.invite.InviteController.'
    ...
    def test_send_email_exception(self):
        ...
        patch('herald_client.client_v2.Client.email_send',
    ...
    def test_not_org_manager_user(self):
        patch('rest_api_server.controllers.invite.InviteController.get_user_auth_assignments',
              return_value=[]).start()
        code, response = self.client.invite_create(self.correct_body)
        self.assertEqual(code, 403)
