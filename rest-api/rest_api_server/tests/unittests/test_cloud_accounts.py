...
class TestCloudAccountApi(TestApiBase):
    ...
    def test_get_or_create_environment_cloud_account(self):
        ...
        patch(
            'rest_api_server.controllers.assignment.AssignmentController.'
