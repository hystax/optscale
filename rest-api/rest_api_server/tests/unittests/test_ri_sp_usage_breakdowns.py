...
class TestRiSpUsageBreakdownApi(TestApiBase):
            ...
            str(self.start_ts): [
                {
                    ...
                    'total_usage_hrs': 10,  # 9.5 + 1800/3600
                    'ri_usage_hrs': 2,
                    'sp_usage_hrs': 0,
                },
                {
    ...
    def test_post(self):
        code, response = self.client.post(
            self.client.ri_sp_usage_breakdown_url(self.org_id), body={})
    ...
    def test_delete(self):
        code, response = self.client.delete(
            self.client.ri_sp_usage_breakdown_url(self.org_id))
        self.assertEqual(code, 405)
