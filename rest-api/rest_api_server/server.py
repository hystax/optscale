        ...
        result.extend([
            ...
            *infrastructure_urls,
            ...
            (urls_v2.risp_processing_tasks_collection,
             ...
             handler_kwargs),
            (urls_v2.ri_sp_usage_breakdown,
             h_v2.ri_sp_usage_breakdowns.RiSpUsageAsyncHandler, handler_kwargs),
            (urls_v2.ri_sp_expenses_breakdown,
             h_v2.ri_sp_expenses_breakdowns.RiSpExpensesAsyncHandler,
             handler_kwargs),
