...
const MlCreateModelFormButtons = ({ onCancel, isLoading = false }: MlCreateModelFormButtonsProps) => (
  <FormButtonsWrapper>
    <SaveButton isLoading={isLoading} />
    <CloseButton onCancel={onCancel} />
  </FormButtonsWrapper>
...
export { MlEditModelFormButtons, MlCreateModelFormButtons };
