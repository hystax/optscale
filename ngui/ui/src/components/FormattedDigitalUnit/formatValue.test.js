...
describe("Testing SI", () => {
  ...
  describe("Converting bytes", () => {
    ...
    test("0.00001 should be 0.00001 bytes", () => {
      expect(convert(0.00001)).toEqual([0.00001, SI_UNITS.BYTE]);
    });
  ...
  describe("Converting megabytes", () => {
    ...
    test("0.00001 should be 0.00001 megabyte", () => {
      expect(convert(0.00001)).toEqual([0.00001, SI_UNITS.MEGABYTE]);
    });
  ...
  describe("Converting petabytes", () => {
    ...
    test("0.00001 should be 0.00001 petabyte", () => {
      expect(convert(0.00001)).toEqual([0.00001, SI_UNITS.PETABYTE]);
    });
...
describe("Testing ISO/IEC 80000 ", () => {
  ...
  describe("Converting bytes", () => {
    ...
    test("0.00001 should be 0.00001 bytes", () => {
      expect(convert(0.00001)).toEqual([0.00001, IEC_UNITS.BYTE]);
    });
    test("0.5 should be 0.5 bytes", () => {
  ...
  describe("Converting megabytes", () => {
    ...
    test("0.00001 should be 0.00001 mebibytes", () => {
      expect(convert(0.00001)).toEqual([0.00001, IEC_UNITS.MEBIBYTE]);
    });
  ...
  describe("Converting pebibtytes", () => {
    ...
    test("0.00001 should be 0.00001 pebibtytes", () => {
      expect(convert(0.00001)).toEqual([0.00001, IEC_UNITS.PEBIBYTE]);
    });
