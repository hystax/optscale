...
const TASK_FIELD_NAME = FIELD_NAMES.TASK;
...
const ABORT_CONDITION_MAX_BUDGET_VALUE_FIELD_NAME = FIELD_NAMES.MAX_BUDGET_VALUE;
const ABORT_CONDITION_REACHED_GOALS_CHECKBOX_FIELD_NAME = FIELD_NAMES.REACHED_GOALS_CHECKBOX;
