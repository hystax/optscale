...
class NetworkTrafficFromFilter extends Filter {
  static filterName = NETWORK_TRAFFIC_FROM_FILTER;

  static apiName = NETWORK_TRAFFIC_FROM_BE_FILTER;

  static displayedName = (<FormattedMessage id="paidNetworkTrafficFrom" />);

  static displayedNameString = intl.formatMessage({ id: "paidNetworkTrafficFrom" });
...
export default NetworkTrafficFromFilter;
