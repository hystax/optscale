  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={submitHandler}>
        <TextWithInlineInput
          messageId="thresholds.obsoleteSnapshotChains"
...
class ObsoleteSnapshotChainsModal extends BaseSideModal {
  headerProps = {
  ...
  get content() {
    return (
      <InformationWrapper>
        <ObsoleteSnapshotChainsThresholds
...
export default ObsoleteSnapshotChainsModal;
