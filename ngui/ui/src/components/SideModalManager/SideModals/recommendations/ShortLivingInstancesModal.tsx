...
class ShortLivingInstancesModal extends BaseSideModal {
  headerProps = {
  ...
  get content() {
    return (
      <InformationWrapper>
        <ShortLivingInstancesThresholds recommendationType={this.payload?.recommendationType} onSuccess={this.closeSideModal} />
      </InformationWrapper>
    );
  }
}

export default ShortLivingInstancesModal;
