...
NebiusProperties.propTypes = {
  accountId: PropTypes.string.isRequired,
  config: PropTypes.shape({
    cloud_name: PropTypes.string.isRequired,
    service_account_id: PropTypes.string.isRequired,
    key_id: PropTypes.string.isRequired,
    access_key_id: PropTypes.string.isRequired,
    bucket_name: PropTypes.string.isRequired,
    bucket_prefix: PropTypes.string.isRequired
  }).isRequired
};
