...
export const findMaxNumber = (array) =>
  array.reduce((maxValue, currentValue) => Math.max(currentValue, maxValue), Number.NEGATIVE_INFINITY);

export const findMinNumber = (array) =>
  array.reduce((maxValue, currentValue) => Math.min(currentValue, maxValue), Number.POSITIVE_INFINITY);

const getSum = (array) => array.reduce((sum, currentValue) => sum + currentValue, 0);

export const getAverage = (array) => getSum(array) / array.length;
