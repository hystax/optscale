    ...
    <Grid container spacing={SPACING_1}>
      <Grid item xs={12}>
        ...
        <Typography component="div">
          <FormattedMessage
            id="finOpsAssessment.dataSourceUsageAnalysisDescription"
            values={{
              p: (chunks) => <p>{chunks}</p>,
        ...
        {hasTableData && (
          <Typography>
            <FormattedMessage id="finOpsAssessment.dataSourceUsageAnalysisTableDescription" />
          </Typography>
        )}
      </Grid>
        ...
        {hasTableData ? (
          <Box display="flex" alignItems="center">
            <FormControlLabel
              ...
              label={
                <Typography>
                  <FormattedMessage id="finOpsAssessment.dataSourcesConnectionConfirmation" />
                </Typography>
              }
            />
            <QuestionMark
              dataTestId="connect_data_sources_help"
              messageId="finOpsAssessment.dataSourcesConnectionConfirmationHint"
              fontSize="small"
            />
          </Box>
        ) : (
          <FormButtonsWrapper withTopMargin={false}>
            <Button
              variant="contained"
              color="success"
