...
const NavigationButtons = ({ index, lastStepIndex, handleNext, handleBack, cancelButton }) =>
  index !== lastStepIndex ? (
    <FormButtonsWrapper withTopMargin>
      {cancelButton}
...
const ProvideDataStepper = ({ steps, cancelButton }) => {
