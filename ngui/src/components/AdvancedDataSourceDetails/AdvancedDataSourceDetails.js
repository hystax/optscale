...
AdvancedDataSourceDetails.propTypes = {
  lastImportAt: PropTypes.number.isRequired,
  lastImportAttemptAt: PropTypes.number.isRequired,
  lastImportAttemptError: PropTypes.string,
  lastMetricsRetrieval: PropTypes.number.isRequired,
  lastMetricsRetrievalAttempt: PropTypes.number.isRequired,
  lastGettingMetricAttemptError: PropTypes.number,
  discoveryInfos: PropTypes.oneOfType([PropTypes.array, PropTypes.object])
};
