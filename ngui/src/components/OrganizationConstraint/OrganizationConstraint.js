...
const OrganizationConstraint = ({ actionBarTitleDefinition, constraint, isLoading = false }) => {
...
OrganizationConstraint.propTypes = {
  constraint: PropTypes.object.isRequired,
  isLoading: PropTypes.bool,
  actionBarTitleDefinition: PropTypes.object.isRequired
};
