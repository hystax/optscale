    ...
    >
      {
        <Grid container spacing={SPACING_2}>
          ...
          <Grid item xs={6}>
            <InfoCard
              title={
                <RecommendationLink category={COST_CATEGORY} dataTestId="block_recommendations_cost_link">
          ...
          <Grid item xs={6}>
            <InfoCard
              title={
                <RecommendationLink category={SECURITY_CATEGORY} dataTestId="block_recommendations_security_link">
