...
TtlAnalysisForm.propTypes = {
  pools: PropTypes.array.isRequired,
  onSubmit: PropTypes.func.isRequired,
  fieldNames: PropTypes.shape({
    poolFieldName: PropTypes.string.isRequired,
    ttlModeFieldName: PropTypes.string.isRequired,
    customTtlFieldName: PropTypes.string.isRequired,
