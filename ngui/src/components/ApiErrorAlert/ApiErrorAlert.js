...
const ApiErrorAlert = () => {
  ...
  // TODO - re-visit ConditionWrapper, check if it is possible not to mount conditional template here.
  // Cannot use it here without additional checks, because body is required, but its value is null on initial load
