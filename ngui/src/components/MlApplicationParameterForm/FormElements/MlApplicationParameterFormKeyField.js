...
const FIELD_MESSAGE_ID = "key";

const MlApplicationParameterFormKeyField = ({ name, isLoading }) => {
  const {
    register,
    formState: { errors }
  } = useFormContext();
  ...
  return isLoading ? (
    ...
    <Input
      ...
      dataTestId="input_key"
    />
  );
};

export default MlApplicationParameterFormKeyField;
