            ...
            {isEmptyArray(parameters) ? (
              <Typography>
                <FormattedMessage
                  ...
                  values={{
                    link: (chunks) => (
                      <Link
                        data-test-id="link_parameters_library"
                        href={ML_APPLICATIONS_PARAMETERS}
                        target="_blank"
                        rel="noopener"
                      >
                        {chunks}
              ...
              <>
                <Typography gutterBottom>
                  <FormattedMessage id="createMlApplication.selectParameters" />
                </Typography>
...
MlModelCreateFormParametersField.propTypes = {
