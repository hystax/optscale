...
class IssueAttachmentController(BaseController):
    ...
    def _find_existing_booking(self, rest_client, employee_id, resource_id,
                               raise_not_found=True):
        now_timestamp = int(datetime.utcnow().timestamp())
        _, resource_info = rest_client.cloud_resource_get(
    ...
    def _create_booking(self, rest_client, organization_id, employee_id,
                        resource_id):
    ...
    def create_attachment(self, client_key, account_id, issue_key, resource_id,
                          auto_detach_status, booking_id=None):
