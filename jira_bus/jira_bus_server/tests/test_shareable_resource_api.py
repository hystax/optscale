...
class TestShareableResourceApi(TestApiBase):
    def setUp(self):
        ...
        employee_id = gen_id()
        patch(
            'jira_bus_server.controllers.shareable_resource.'
    ...
    def test_list_shareable_resources(self):
        ...
        allowed_action_get_response = self.get_response_mock(
            'allowed_action_get')
        self.rest_cl_mock.shareable_resources_list.return_value = (
            200, self.get_response_mock('shareable_resources_list'))
        self.auth_cl_mock.allowed_action_get.return_value = (
            200, allowed_action_get_response)
        ...
        for resource in resp['shareable_resources']:
            self.assertEqual(
                ...
                expected_permissions[
                    'BOOK_ENVIRONMENTS' in allowed_action_get_response[
                        resource['id']]])
    ...
    def test_issue_scope_list(self):
        ...
        self.rest_cl_mock.shareable_resources_list.return_value = (
            200, shareable_resources_list_response)
        self.auth_cl_mock.allowed_action_get.return_value = (
            200, self.get_response_mock('allowed_action_get'))
    ...
    def test_no_atlassian_auth(self):
        ...
        code, resp = no_auth_client.shareable_resource_list(
            current_issue=False)
    ...
    def test_no_atlassian_account(self):
        ...
        code, resp = no_account_client.shareable_resource_list(
            current_issue=False)
        self.assertEqual(code, 401)
