...
class TestOrganizationAssignmentApi(TestApiBase):
    ...
    def test_get_assignment(self):
        ...
        self.rest_cl_mock.organization_get.return_value = (
            200, self.get_response_mock('organization_get'))
    ...
    def test_create_and_recreate_assignment(self):
        ...
        self.m_optscale_permission.side_effect = OptHTTPError(
            401, Err.OJ0018, [])
        ...
        def has_permission_only_for_organization1(
                action, type, resource_id, auth_token=None):  # noqa
            if resource_id != organization1_id:
                raise OptHTTPError(401, Err.OJ0018, [])

        self.m_optscale_permission.side_effect = (
            has_permission_only_for_organization1)
        ...
        self.m_optscale_permission.side_effect = (
            has_permission_only_for_organization2)
    ...
    def test_no_atlassian_auth(self):
        ...
        code, resp = no_auth_client.organization_assignment_create(
