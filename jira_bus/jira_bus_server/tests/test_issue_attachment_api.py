...
class TestIssueAttachmentApi(TestApiBase):
    ...
    def test_create_attachment(self):
        ...
        patch(
            'jira_bus_server.controllers.issue_attachment.'
        ...
        p_find_existing_booking = patch(
            ...
            return_value=existing_booking_id).start()
        ...
        self.rest_cl_mock.jira_issue_attachment_create.return_value = (
            200, jira_issue_attachment_create_response)

        code, resp = client.issue_attachment_create(resource_id, {})
        self.assertEqual(code, 200)
        self.assertEqual(
            resp['id'], jira_issue_attachment_create_response['id'])
        ...
        code, resp = client.issue_attachment_create(resource_id, {
            'booking_id': manually_specified_booking_id})
        self.assertEqual(code, 200)
