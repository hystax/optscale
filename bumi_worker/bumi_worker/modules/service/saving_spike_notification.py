...
class SavingSpikeNotification(ServiceBase):
    ...
    def _get(self):
        ...
        if skip_notifications:
            LOG.info(f'Skip notifications for organization'
        ...
        if current_total > previous_total + previous_total * threshold / 100:
            LOG.info(f'Found saving spike for organization '
                     f'{self.organization_id}. Previous total: '
                     f'{previous_total}, current total: {current_total}')
