...
def upgrade():
    ...
    sa.UniqueConstraint('role_purpose', 'scope_id', name='uc_recipient_role_purpose_scope_user')
    )
    ...
    sa.Column('report_format', sa.Enum('html', name='reportformat'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('report_id', 'recipient_id', 'crontab', name='uc_schedule_report_recipient_crontab')
    )
    ...
    sa.Column('state', sa.Enum('created', 'started', 'got_recipients', 'generating_data', 'completed', 'error', name='taskstate'), nullable=False),
